 function paginator(config) {
    ...
    if (!(typeof config.page_options == "boolean" && !config.page_options)) 
    {
        ...
        select.setAttribute("class", "custom-select ml-2 col-1");
    ...
    stat.innerHTML = "<b> En la pagina " + page + " de " + pages
        + ", filas " + (((page-1)*rows_per_page)+1)
        + " con " + (trs.length<page*rows_per_page||rows_per_page==0?trs.length:page*rows_per_page)
