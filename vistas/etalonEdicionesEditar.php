    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                ...
                <?php 
                $consultaSqlCargas=muestraRegistroEdicionDeVerciones(
                    $con,$_GET['hojaDeViajeID']
                );
                    $edicion;
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <form>
                        <div data-hojadeviajeid="<?php echo $edicion['hojaDeViajeID']?>" id="hojaDeViajeID" >
                        <div data-hojadeviajeedicionid="<?php echo $_GET['hojaDeViajeID']?>" id="hojaDeViajeEdicionID">
                        </div>
                        <div data-sesionid="<?php echo $edicion['hojaDeViajeEdicionUsuarioEdicion']?>" id="sesionId" >
                        </div>
                            <div class="form-row ">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button" class="btn btn-warning col-md-6" id="editarTalonNuevo">Establecer como ultima edicion</button>
                            </div>
...
<?php
    ...
    include "../import/componentes/js/talonEdiciones.php";
?>
