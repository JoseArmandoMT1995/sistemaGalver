        ...
        <ul class="navbar-nav color-sidebar sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTRES" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded collapseColor">
                        <h6 class="collapse-header text-amarillo">Opciones:</h6>
                        <a class="collapse-item text-amarillo" href="./CRUD_EmpresaEmisora.php"><i
                                class="fas fa-building"></i> Empresa Emisora</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_EmpresaReceptora.php"><i
                                class="far fa-building"></i> Empresa Receptora</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Operadores.php"><i class="fas fa-smile"></i>
                            Operadores</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Tractores.php"><i
                                class="fas fa-truck-moving"></i> Tractores</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Tractores_marca.php"><i
                                class="fab fa-bandcamp"></i> Marca de veiculos</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Remolques.php"><i
                                class="fas fa-trailer"></i> Remolques</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Remolques_servicios.php"><i
                                class="fas fa-concierge-bell"></i> Remolques Servicios</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Cargas.php"><i class="fas fa-boxes"></i>
                            Cargas</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Unidades_de_medida.php"><i
                                class="fas fa-ruler-vertical"></i> Unidades de medida</a>
                        <a class="collapse-item text-amarillo" href="./CRUD_Destinos.php"><i
                                class="fas fa-map-marked"></i> Destino</a>
                    </div>
                </div>
            </li>
